...
const ZH_T = {
  ...
  "settings.title": "SubAgent Magazine — 设置",
  "settings.section.general": "通用",
  "settings.lang": "语言",
  "settings.max": "最大条目数",
  "settings.order": "排序方式",
  "settings.scroll": "滚动模式",
  "settings.ttl": "保留期限",
  "settings.border": "面板边框",
  "settings.showEntryCost": "每条子代理显示费用",
  "settings.showEntryTime": "列表中显示耗时",
  "settings.showEntryTokens": "列表中显示 Token 数",
  "settings.timeFormat": "时间格式",
  "settings.showOrigin": "列表显示来源标记",
  "settings.dbSync": "本地数据库补全",
  "settings.on": "开",
  "settings.off": "关",
  "settings.saved": "已保存 {item}：{value}",
  "settings.invalid": "无效的数值",
  "settings.close": "关闭",
} as const
...
const EN_T: Translation = {
  ...
  "agent.label": "agent",
  "origin.label": "origin",
  "origin.tool": "sub-agent call",
  "origin.sub": "spawned session",
  ...
  "settings.title": "SubAgent Magazine — Settings",
  "settings.section.general": "General",
  "settings.lang": "Language",
  "settings.max": "Max entries",
  "settings.order": "Sort order",
  "settings.scroll": "Scroll mode",
  "settings.ttl": "Retention",
  "settings.border": "Panel border",
  "settings.showEntryCost": "Cost per sub-agent",
  "settings.showEntryTime": "Elapsed time in list",
  "settings.showEntryTokens": "Token count in list",
  "settings.showOrigin": "Origin indicators in list",
  "settings.timeFormat": "Time format",
  "settings.dbSync": "Local database enrichment",
  "settings.on": "on",
  "settings.off": "off",
  "settings.saved": "Saved {item}: {value}",
  "settings.invalid": "Invalid value",
...
const JA_T: Translation = {
  ...
  "agent.label": "エージェント",
  "origin.label": "発生元",
  "origin.tool": "サブエージェント呼び出し",
  "origin.sub": "生成されたセッション",
  "origin.background": "バックグラウンド",
  "status.label": "状態",
  "time.label": "時間",
  "tokens.label": "コンテキスト",
  "error.label": "エラー",
  ...
  "settings.title": "SubAgent Magazine — 設定",
  ...
  "settings.ttl": "保持期間",
  "settings.border": "パネル枠",
  "settings.showEntryCost": "サブエージェント毎の費用",
  "settings.showEntryTime": "一覧に所要時間を表示",
  "settings.showEntryTokens": "一覧にトークン数を表示",
  "settings.showOrigin": "一覧に由来マークを表示",
  "settings.timeFormat": "時間形式",
  "settings.dbSync": "ローカルDB補完",
  "settings.on": "オン",
  "settings.off": "オフ",
  "settings.saved": "保存しました {item}：{value}",
  "settings.invalid": "無効な値です",
  "settings.close": "閉じる",
}
...
const KO_T: Translation = {
  ...
  "agent.label": "에이전트",
  "origin.label": "출처",
  "origin.tool": "하위 에이전트 호출",
  "origin.sub": "생성된 세션",
  "origin.background": "백그라운드",
  "status.label": "상태",
  "time.label": "시간",
  "tokens.label": "컨텍스트",
  "error.label": "오류",
  ...
  "settings.title": "SubAgent Magazine — 설정",
  "settings.section.general": "일반",
  "settings.lang": "언어",
  "settings.max": "최대 항목 수",
  "settings.order": "정렬 순서",
  "settings.scroll": "스크롤 모드",
  "settings.ttl": "보존 기간",
  "settings.border": "패널 테두리",
  "settings.showEntryCost": "하위 에이전트별 비용",
  "settings.showEntryTime": "목록에 소요 시간 표시",
  "settings.showEntryTokens": "목록에 토큰 수 표시",
  "settings.showOrigin": "목록에 출처 아이콘 표시",
  "settings.timeFormat": "시간 형식",
  "settings.dbSync": "로컬 DB 보완",
  "settings.on": "켬",
  "settings.off": "끔",
  "settings.saved": "저장됨 {item}: {value}",
  "settings.invalid": "잘못된 값",
  "settings.close": "닫기",
}
